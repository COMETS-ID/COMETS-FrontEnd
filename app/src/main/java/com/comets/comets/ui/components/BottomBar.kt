...
import com.comets.comets.ui.navigation.NavigationItem
...
fun BottomBar(
    ...
    val navigationItems = listOf(
        NavigationItem(
            ...
            screen = Screen.ApplicationContent.Home
        ),
        NavigationItem(
            title = "Journal",
            ...
            screen = Screen.ApplicationContent.Journal
        ),
        NavigationItem(
            title = "Connect",
            ...
            screen = Screen.ApplicationContent.Connect
        ),
    )
    BottomNavigationBar(
